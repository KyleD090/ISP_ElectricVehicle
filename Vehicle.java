public class Vehicle {
    ...
    public String outputRPM() {
        ...
        return "The mBrake is released allowing the transmission to use the Horsepower to calculate the Torque and output " + mTransmission.outputRPM() + " Rotations per Minute to the wheels";
    }

    public String outputMPH() {
        return "The car is moving at " + mTransmission.outputMPH() + " Miles Per Hour";
    }

    public String pressGasPedal(){
        return "The gas petal is mPressed sending " + mMotorController.secondCurrentInput(0.2) + " amps to the Motor Controller";
    }
