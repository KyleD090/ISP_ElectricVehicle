public class AutomaticTransmission extends Transmission {
    ...
    AutomaticTransmission(Clutch pClutch, Chassis pChassis, double pGear1, double pGear2, double pGear3, double pGear4, double pGear5, double pGear6, int pSpeed1, int pSpeed2, int pSpeed3, int pSpeed4, int pSpeed5) {
